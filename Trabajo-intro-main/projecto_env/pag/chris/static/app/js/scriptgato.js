let correctasgato=[2,3,4,1,1,1,1]
...
function corregirgato(){
    cantidadgatos=0;
    for(i=0; i< correctasgato.length;i++){
        if (correctasgato[i]==opciongato[i]){
            cantidadgatos++
        }
    }
