...
function corregir(){
    ...
    if( opcion_elegida[1]==1 && opcion_elegida[2]==1 && opcion_elegida[3]==1 && opcion_elegida[4]==2 && opcion_elegida[9]==2){
    ...
    if(opcion_elegida[0]==1 && opcion_elegida[1]==1 && opcion_elegida[2]==1 && opcion_elegida[3]==2 && opcion_elegida[4]==2 && opcion_elegida[9]==2){
    ...
    else if(  opcion_elegida[3]==2 && opcion_elegida[5]==1 ) {
    }
    ...
    else if(opcion_elegida[0]==2 && opcion_elegida[1]==2 && opcion_elegida[2]==2 && opcion_elegida[3]==2 && opcion_elegida[5]==2 && opcion_elegida[7]==2){
        document.getElementById("conclusion").innerHTML= "Recomendacion: Te recomendamos que en otro momento de tu vida consigas una mascota.";
    }
    else if(opcion_elegida[1]==1 && opcion_elegida[2]==2 && opcion_elegida[3]==2 && opcion_elegida[5]==2){
        document.getElementById("conclusion").innerHTML="Recomendacion: Un perro calzaria contigo."
    }
    else{
        document.getElementById("conclusion").innerHTML= "Por ahora no tenemos la mascota perfecta para ti, vuelve pronto.";
    }
}
