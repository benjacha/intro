...
function corregir(){
    ...
    else if( opcion_elegida[0]==1 && opcion_elegida[1]==1 && opcion_elegida[2]==2 && opcion_elegida[3]==2 && opcion_elegida[5]==2 && opcion_elegida[9]==2){
    ...
    else if( opcion_elegida[2]==2 && opcion_elegida[5]==2 ){
        document.getElementById("conclusion").innerHTML="Recomendacion: Una tortuga calzaria contigo."
    }
